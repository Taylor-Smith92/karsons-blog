...
<html lang="en">
	...
	<body>
		...
		<p>My site will be one page and have the following sections:</p>
		<p><strong>Welcome:</strong> When the site opens at the top of the page will be a picture and the page name printed on top. As well as a brief description of what kind of a blog it is.</p>
		<p><strong>Menu:</strong> There will be a menu that when selected overlays the page content. It will include links to other social media
